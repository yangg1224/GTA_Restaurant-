...
```{r restaurant_number, echo=FALSE, fig.width=6, fig.height=5}
R1<-simulated_data%>%
...
```{r franchise, echo=FALSE, fig.width=10, fig.height=4}
...
```{r employee#, echo=FALSE, fig.width=10, fig.height=4}
cxc <- 
  simulated_data%>%
...
```{r revenue_distribution, fig.cap="Revenue distribution",echo=FALSE}
...
```{r felx_fix, echo=FALSE, fig.width=6, fig.height=4}
# Treated group
...
### correlation matrix
```{r correlation, echo=FALSE, fig.width=20, fig.height=10}
