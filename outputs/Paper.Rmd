...
# Data 
In this report, we use the R statistical programming language [@citeR]. To be specific, we use the “tidyverse” package to process data [@citetidyverse], "kableExtra" package to generate tables [@citekableExtra],  ADD ANY PACKAGE HERE. The survey conducted by Petit Poll collects the following data:
...
[Appendix C](#appendixC) shows screen captures of the online version of the survey.In addition, we consulted several open datasets about the health inspection from each region. (CITATION)
